...
This project trains a semantic segmentation model for urban scene understanding using a SegFormer-based architecture inspired by the original SegFormer paper. It is designed for the Cityscapes Kaggle dataset and predicts 19 semantic classes such as road, building, sky, vehicle, and person.
